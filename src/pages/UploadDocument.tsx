        ...
        {hasCredits && cooldownChecked && remainingSeconds === 0 && (
          <Card className="border-green-500/30 bg-green-500/5">
            <CardContent className="p-4 text-center">
              <p className="font-semibold text-green-600">You can upload a new file now</p>
            </CardContent>
          </Card>
        )}
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                <p>
                  You can upload only <strong className="text-foreground">1 file</strong> every{' '}
                  <strong className="text-foreground">{uploadCooldownMinutes} minutes</strong>
                </p>
                <p>
                  Each file must be less than <strong className="text-foreground">100 MB</strong>
                </p>
